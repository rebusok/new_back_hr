...
import {emailRegExp, emailValidator} from "../helpers/validators";
import User, {IUser} from "../models/user";
import {generateResetPasswordToken} from "../helpers/generateToken";
import {sendMail} from "../helpers/gmail";
    ...
    if (!emailValidator(email)) res.status(400)
        ...
        if (!user) res.status(404)
            ...
            try {
                ...
                const fromFinal = from || "Admin_CRM <hr.crmad@gmail.com>";
